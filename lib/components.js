...
class Form extends React.Component {
  constructor(props) {
    ...
    // valeurs recalculées, sans logique dédiée côté écran.
    this._cddHandleChange = function (value, path) {
      var out = value;
      var page = this.props.page;
      if (page && Array.isArray(page.calculate) && page.calculate.length) {
        out = require("./cdd-form-logic").applyCalculations(page, value);
      }
  ...
  checkPageRequired() {
    ...
    return logic.checkPageRequired(page, value, opts);
  }
  ...
  render() {
    ...
    if (cddLogic && cddLogic.hasDeclarativeLogic(this.props.page)) {
